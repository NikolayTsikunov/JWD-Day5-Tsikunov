...
public class DeletingPartsTextAsCharImplTest {

    DeletingPartsText deletingPartsText;

    @BeforeTest
    private void initialization() {
        deletingPartsText = new DeletingPartsTextAsCharImpl();
    }
    ...
    public void deleteOptionalLengthWordsTest() throws ProgramException {
    ...
    @Test(expectedExceptions = ProgramException.class,
            expectedExceptionsMessageRegExp = "Wrong entry data")
    public void deleteOptionalLengthWordsExceptionTest() throws ProgramException {
